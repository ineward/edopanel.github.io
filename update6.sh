...
if [ ! -d /www/server/panel/BTPanel ];then
	...
	echo "5.9平滑升级到6.0的命令：curl https://download.seele.wang/ltd/install/update_to_6.sh|bash"
	exit 0;
fi
...
downloadst_Url=https://dempoedu.st-albertus.sch.id/soft/panel
setup_path=/www
...
wget -T 5 -O /tmp/panel.zip $downloadst_Url/install/update/LinuxPanel-${version}.zip
